...
type Context func(t *testing.T, mock *mocks.MockBackendAdapter, server *httptest.Server)
...
func testDelete(t *testing.T, mock *mocks.MockBackendAdapter, instance *ServiceClient) {
